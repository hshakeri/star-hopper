...
// Bump the version below in lockstep with index.html's ?v=fast-v503 on every release.
const CACHE = 'star-hopper-fast-v503';
const CORE = [
  './',
  './index.html',
  './style.css?v=fast-v503',
  './manifest.json?v=fast-v503',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png'
];
