...
// Bump the version below in lockstep with index.html's ?v=clean-v500 on every release.
const CACHE = 'star-hopper-clean-v500';
const CORE = [
  './',
  './index.html',
  './style.css?v=clean-v500',
  './manifest.json?v=clean-v500',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png'
];
