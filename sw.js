...
// Bump the version below in lockstep with index.html's ?v=audio-speech-v506 on every release.
const CACHE = 'star-hopper-audio-speech-v506';
const CORE = [
  './',
  './index.html',
  './style.css?v=audio-speech-v506',
  './manifest.json?v=audio-speech-v506',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-512.png'
];
